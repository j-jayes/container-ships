...
get_data_vessel_finder <- function(url){
  ...
  table <- table %>% 
    ...
    mutate(type = str_squish(str_extract(name, " Container Ship| Crude Oil Tanker")),
           name = str_remove_all(name, " Container Ship| Crude Oil Tanker"),
...
get_data_vessel_finder("https://www.vesselfinder.com/vessels?page=1&type=0")
